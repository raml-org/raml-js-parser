...
(function() {
  ...
  this.Composer = (function() {
    function Composer(validate, apply, join) {
      this.validate = validate != null ? validate : true;
      this.apply = apply != null ? apply : true;
      this.join = join != null ? join : true;
      this.anchors = {};
    }
    ...
    */
    ...
    Composer.prototype.compose_node = function(parent, index) {
      ...
      if (this.check_event(events.ScalarEvent)) {
        node = this.compose_scalar_node(anchor, index);
...
(function() {
  ...
  this.make_loader = function(Reader, Scanner, Parser, Composer, Resolver, Validator, ResourceTypes, Traits, Schemas, Protocols, Joiner, SecuritySchemes, Constructor, Transformations) {
    ...
    return (function() {
      ...
      function _Class(stream, location, validate, apply, join, parent) {
        var _i, _len, _ref;
        this.parent = parent != null ? parent : null;
        components[0].call(this, stream, location);
        components[1].call(this, validate, apply, join);
        components[2].call(this, validate, apply, join);
        components[3].call(this, validate, apply, join);
        components[4].call(this, apply);
...
(function() {
  ...
  */
  ...
  this.Transformations = (function() {
    function Transformations(apply) {
      this.apply = apply != null ? apply : true;
